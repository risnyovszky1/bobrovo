    ...
    <div class="col-lg-8 pt-3 pb-3">
      ...
      <form action="" method="post">
        <div class="form-group">
          ...
          <input type="text" name="address" id="address" class="form-control" value="{{ $msg->first_name . ' ' . $msg->last_name . ' ('. $msg->email . ')' }}" readonly>
...
{{ $msg->content }}
        ...
        <div class="form-group">
          {{ csrf_field() }}
          <button type="submit" class="btn btn-lg btn-primary"><i class="fas fa-paper-plane"></i> Poslať </button>
        </div>
      </form>
    </div>
  </div>
