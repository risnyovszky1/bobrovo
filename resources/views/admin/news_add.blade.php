    ...
    <form action="" method="post">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="custom-control custom-radio">
            <input type="radio" id="customRadio1" name="is-visible" value="yes" class="custom-control-input">
            <label class="custom-control-label" for="customRadio1">Visible</label>
          </div>
          <div class="custom-control custom-radio">
            <input type="radio" id="customRadio2" name="is-visible" value="no" class="custom-control-input">
      ...
      <div class="row">
        <div class="col-md-12 pt-3">
          {{ csrf_field() }}
          <button type="submit" class="btn btn-primary btn-lg"><i class="fas fa-plus-circle"></i> Pridaj</button>
        </div>
      </div>
    </form>
  </div>
