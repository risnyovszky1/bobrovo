        ...
        <div class="col-lg-7 pt-2">
            ...
            <form action="" method="post">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="first-name" name="first-name" value="{{Auth::user()->first_name}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="last-name" name="last-name" value="{{Auth::user()->last_name}}">
                    </div>
                </div>
                ...
                <div class="form-group row" style="align-items: center;">
                    ...
                    <div class="col-sm-9">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input disabled" disabled id="customCheck1" {{Auth::user()->is_admin ? 'checked' : ''}}>
