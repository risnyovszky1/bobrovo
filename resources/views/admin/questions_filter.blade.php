        ...
        <div class="col-lg-8 pt-2">
            <div id="filter">
                ...
                <form action="" method="post">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-8">
                              ...
                              <div class="custom-control custom-checkbox">
                                  <input type="checkbox" class="custom-control-input" id="category-1" name="category[]" value="1" {{ $category && in_array(1, $category) ? 'checked' : '' }}>
                                  <label class="custom-control-label" for="category-1">Informácie okolo nás</label>
                              </div>

                              <div class="pl-5 mt-1">
                                  <div class="custom-control custom-checkbox">
                                      <input type="checkbox" class="custom-control-input" id="category-6" name="category[]" value="6" {{ $category && in_array(6, $category) ? 'checked' : '' }}>
                                      <label class="custom-control-label" for="category-6">kódovanie, šifrovanie, komprimácia informácie</label>
                                  </div>

                                  <div class="custom-control custom-checkbox">
                                      <input type="checkbox" class="custom-control-input" id="category-7" name="category[]" value="7" {{ $category && in_array(7, $category) ? 'checked' : '' }}>
                                      <label class="custom-control-label" for="category-7">číselné sústavy, prevody</label>
                                  </div>

                                  <div class="custom-control custom-checkbox">
                                      <input type="checkbox" class="custom-control-input" id="category-8" name="category[]" value="8" {{ $category && in_array(8, $category) ? 'checked' : '' }}>
                                  ...
                                  <div class="custom-control custom-checkbox">
                                      <input type="checkbox" class="custom-control-input" id="category-9" name="category[]" value="9" {{ $category && in_array(9, $category) ? 'checked' : '' }}>
                                      <label class="custom-control-label" for="category-9">vyhľadávanie opakujúcich sa vzorov</label>
                                  </div>

                                  <div class="custom-control custom-checkbox">
                                      <input type="checkbox" class="custom-control-input" id="category-10" name="category[]" value="10" {{ $category && in_array(10, $category) ? 'checked' : '' }}>
                                  ...
                                  <div class="custom-control custom-checkbox">
                                      <input type="checkbox" class="custom-control-input" id="category-11" name="category[]" value="11" {{ $category && in_array(11, $category) ? 'checked' : '' }}>
                              ...
                              <div class="pl-4 mt-2 mb-1">
                                  <div class="custom-control custom-checkbox">
                                      <input type="checkbox" class="custom-control-input" id="category-12" name="category[]" value="12" {{ $category && in_array(12, $category) ? 'checked' : '' }}>
                                  ...
                                  <div class="custom-control custom-checkbox">
                                      <input type="checkbox" class="custom-control-input" id="category-13" name="category[]" value="13" {{ $category && in_array(13, $category) ? 'checked' : '' }}>
                                  ...
                                  <div class="custom-control custom-checkbox">
                                      <input type="checkbox" class="custom-control-input" id="category-14" name="category[]" value="14" {{ $category && in_array(14, $category) ? 'checked' : '' }}>
                                  ...
                                  <div class="custom-control custom-checkbox">
                                      <input type="checkbox" class="custom-control-input" id="category-15" name="category[]" value="15" {{ $category && in_array(15, $category) ? 'checked' : '' }}>
                                  ...
                                  <div class="custom-control custom-checkbox">
                                      <input type="checkbox" class="custom-control-input" id="category-16" name="category[]" value="16" {{ $category && in_array(16, $category) ? 'checked' : '' }}>
                                      <label class="custom-control-label" for="category-16">prezentácia informácií - kompetencie potrebné na tvorbu prezentácií</label>
                                  </div>

                                  <div class="custom-control custom-checkbox">
                                      <input type="checkbox" class="custom-control-input" id="category-17" name="category[]" value="17" {{ $category && in_array(17, $category) ? 'checked' : '' }}>
                              ...
                              <div class="custom-control custom-checkbox">
                                  <input type="checkbox" class="custom-control-input" id="category-2" name="category[]" value="2" {{ $category && in_array(2, $category) ? 'checked' : '' }}>
                                  <label class="custom-control-label" for="category-2">Komunikácia prostredníctvom digitálnych technológií</label>
                              </div>

                              <div class="custom-control custom-checkbox">
                                  <input type="checkbox" class="custom-control-input" id="category-3" name="category[]" value="3" {{ $category && in_array(3, $category) ? 'checked' : '' }}>
                                  <label class="custom-control-label" for="category-3">Postupy, riešenie problémov, algoritmické myslenie</label>
                              </div>

                              <div class="custom-control custom-checkbox">
                                  <input type="checkbox" class="custom-control-input" id="category-4" name="category[]" value="4" {{ $category && in_array(4, $category) ? 'checked' : '' }}>
                                  <label class="custom-control-label" for="category-4">Princípy fungovania digitálnych technológií</label>
                              </div>

                              <div class="custom-control custom-checkbox">
                                  <input type="checkbox" class="custom-control-input" id="category-5" name="category[]" value="5" {{ $category && in_array(5, $category) ? 'checked' : '' }}>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                    <select name="order" id="order" class="form-control">
                                        <option value="1" {{ $order && $order == 1 ? 'selected' : '' }}>Podľa názvu</option>
                                        <option value="2" {{ $order && $order == 2 ? 'selected' : '' }}>Podľa počtu kommentov</option>
                                        <option value="3" {{ $order && $order == 3 ? 'selected' : '' }}>Podľa hodnetiní</option>
                                        <option value="4" {{ $order && $order == 4 ? 'selected' : '' }}>Podľa počtu hodnotení</option>
                                        <option value="5" {{ $order && $order == 5 ? 'selected' : '' }}>Podľa použití v testoch</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select name="difficulty_to" id="difficulty_to" class="form-control">
                                  ...
                                  <option value="7" {{ $diffTo == 7 || $diffTo == null ? 'selected' : ''}}>7</option>
                                </select>
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="custom-control custom-radio custom-control-inline">
                              <input type="radio" id="no-interactive" name="type" class="custom-control-input" value="no-interactive" {{ $type && $type == 'no-interactive' ? 'checked' : '' }}>
                              <label class="custom-control-label" for="no-interactive">bez interaktívnych</label>
                          </div>
                          <div class="custom-control custom-radio custom-control-inline">
                              <input type="radio" id="with-interactive" name="type" class="custom-control-input" value="with-interactive" {{ $type && $type == 'with-interactive' ? 'checked' : '' }}>
                              <label class="custom-control-label" for="with-interactive">aj interaktívne</label>
                          </div>
                          <div class="custom-control custom-radio custom-control-inline">
                              <input type="radio" id="just-interactive" name="type" class="custom-control-input" value="just-interactive" {{ $type && $type == 'just-interactive' ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        {{ csrf_field() }}
                        <button type="submit" class="btn btn-primary"><i class="fas fa-filter"></i> Uložiť filter</button>
                        <a href="{{ route('questions.filter.reset') }}" class="btn btn-danger"><i class="fas fa-redo-alt"></i> Zrušiť filter</a>
                    </div>
                </form>
            </div>
        </div>
