...
<header id="header-admin">
    <nav class="navbar navbar-expand-lg navbar-dark bg-bobrovo-orange">
        ...
        <button class="navbar-toggler bg-bobrovo-green-light text-white border-white" type="button"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a href="{{ route('tests_student') }}" class="nav-link"><i
                                class="fas fa-file-alt"></i> {{  __('student.Tests') }}</a>
                </li>
                <li class="nav-item dropdown">
                    <a href="{{ route('groups_student') }}" class="nav-link"><i
                                class="fas fa-users"></i> {{  __('student.Groups') }}</a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-danger btn-sm nav-link ml-2" href="{{ route('logout_student') }}"><i
                                class="fas fa-sign-out-alt"></i> {{  __('student.Logout') }}</a>
                </li>
            </ul>
        </div>
    </nav>
