                    ...
                    <form action="" method="post">
                            ...
                            <div class="form-group">
                                <div class="answer-wrapper border rounded border-primary bg-white pt-2 pb-2 pl-3 pr-3 mb-2">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio-{{$question->id}}a" value="a"
                                               name="answer-{{$question->id}}"
                                               class="custom-control-input" {{ !empty($answer) && $answer->answer == 'a' ? 'checked' : '' }}>
                                        <label class="custom-control-label"
                                               for="customRadio-{{$question->id}}a">{{$question->a}}</label>
                                    </div>
                                </div>
                                <div class="answer-wrapper border rounded border-primary bg-white pt-2 pb-2 pl-3 pr-3 mb-2">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio-{{$question->id}}b" value="b"
                                               name="answer-{{$question->id}}"
                                               class="custom-control-input" {{ !empty($answer) && $answer->answer == 'b' ? 'checked' : '' }}>
                                        <label class="custom-control-label"
                                               for="customRadio-{{$question->id}}b">{{$question->b}}</label>
                                    </div>
                                </div>
                                <div class="answer-wrapper border rounded border-primary bg-white pt-2 pb-2 pl-3 pr-3 mb-2">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio-{{$question->id}}c" value="c"
                                               name="answer-{{$question->id}}"
                                               class="custom-control-input" {{ !empty($answer) && $answer->answer == 'c' ? 'checked' : '' }}>
                                        <label class="custom-control-label"
                                               for="customRadio-{{$question->id}}c">{{$question->c}}</label>
                                    </div>
                                </div>
                                <div class="answer-wrapper border rounded border-primary bg-white pt-2 pb-2 pl-3 pr-3 mb-2">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio-{{$question->id}}d" value="d"
                                               name="answer-{{$question->id}}"
                                               class="custom-control-input" {{ !empty($answer) && $answer->answer == 'd' ? 'checked' : '' }}>
                                        <label class="custom-control-label"
                                               for="customRadio-{{$question->id}}d">{{$question->d}}</label>
                                    </div>
                                </div>
                            </div>
                            @break
                        ...
                        <div class="form-group mt-4">
                            ...
                            <button type="submit" class="btn btn-lg btn-primary"><i
                                        class="fas fa-save"></i> {{ __('student.save-answer') }}</button>
                        </div>
                        <hr>
                    </form>
                </div>
