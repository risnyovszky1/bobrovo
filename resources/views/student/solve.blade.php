    ...
    <div class="row">
        <div class="col-md-8 pb-3">
            @if (!empty($state) && $state->state == 3)
                ...
                <a href="{{ route('results_student', ['id' => Session::get('testSettings')->id]) }}" class="btn btn-success">
            ...
            @else
                ...
                <div class="form-group">
                    <a href="{{ route('question_student', ['id' => Session::get('testSettings')->id, 'ord' => 1])}}" class="btn btn-success">
                        <i class="fas fa-play-circle"></i> Začať
                    </a>
    
                    <a href="{{ route('finish_student', ['id' => Session::get('testSettings')->id]) }}" class="btn btn-danger">
