<style>
    ...
    .student-table thead tr th {padding: 10px 10px; font-weight:bold; background:#efefef; border-color: #666666}
    .student-table tr td{padding: 6px 10px; vertical-align: middle; border-top: 1px solid #999;} 
