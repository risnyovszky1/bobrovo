        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-lg-10 offset-lg-1 text-center pt-3 pb-3">
                    <h1>O nás</h1>
                    <p class="lead">
                        Tart jelly-o sesame snaps cake wafer. Cake caramels oat cake pie chocolate bar. Jelly-o bear
                        claw tootsie roll dragée
                        jelly beans macaroon sweet roll. Oat cake powder bear claw fruitcake. Pastry jelly beans ice
                        cream marzipan oat cake
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="tel" name="telnumber" class="form-control"
                                   placeholder="Zadajte svoje telefónne čislo">
                        </div>
                    </div>
                </div>
                <div class="row">
